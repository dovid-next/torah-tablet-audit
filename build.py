"""
Regenerate public/index.html from audit.md + versions_full.json + books.json.

Usage:
    pip install -r requirements.txt
    python build.py

Cloudflare Pages runs this on every push to main (see README).
"""
...
for required in (SRC_MD, VERSIONS_JSON, BOOKS_JSON):
